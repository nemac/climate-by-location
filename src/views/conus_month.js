      ...
      const monthly_content = `
        <div class="label1">${month} projection</div>
          ...
          <div  class="bg-rcp85" style="grid-column: 1; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} higher emissions weighted mean" class="legend-line" style="width: 75%; font-size: 1.1rem; margin: 0 0 0 .3rem;">${round(chart_data['rcp85_mean'][month_idx], precision)}</div>
          </div>
          ...
          <div class="bg-rcp85" style="grid-column: 2; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} higher emissions range" class="legend-area"  style="width: 75%; font-size: 0.8rem; margin: 0 0 0 .3rem;"><span>${round(chart_data['rcp85_min'][month_idx], precision)}</span><span>&mdash;</span><span>${round(chart_data['rcp85_max'][month_idx], precision)}</span></div>
          </div>
          ...
          <div class="bg-rcp45" style="grid-column: 1; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} lower emissions weighted mean" class="legend-line" style="width: 75%; font-size: 1.1rem; margin: 0 0 0 .3rem;">${round(chart_data['rcp45_mean'][month_idx], precision)}</div>
          </div>
          ...
          <div class="bg-rcp45" style="grid-column: 2; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} lower emissions range" class="legend-area"  style="width: 75%; font-size: 0.8rem; margin: 0 0 0 .3rem;">${round(chart_data['rcp45_min'][month_idx], precision)}</span><span>&mdash;</span><span>${round(chart_data['rcp45_max'][month_idx], precision)}</div>
          </div>
          ...
          <div style="grid-column: 1 / span 2; display: flex; align-items: center; width: 50%;">
            ...
            <hr style="width: 25%; margin: 0 .3rem 0 .3rem; border-top: 0.15rem dashed ${rgba(colors.hist.line, 1)};">
            
            <div title="1950-2013 observed" class="legend-line" style="width: 75%; font-size: 0.8rem; margin: 0 0 0 .3rem;">${round(chart_data['hist_obs'][month_idx], precision)}</div>
          </div>
        `;
