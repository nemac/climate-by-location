      ...
      const monthly_content = `
        <div class="label1">${month} projection</div>
          ...
          <div  class="bg-rcp85" style="grid-column: 1; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} higher emissions weighted mean" class="legend-line" style=" font-size: 1.1rem; margin: 0 0 0 .3rem;">${round(chart_data['rcp85_mean'][month_idx], precision)}</div>
          </div>
          ...
          <div class="bg-rcp45" style="grid-column: 1; padding-bottom: 0.25rem; display: flex; align-items: center;">
            ...
            <div title="${month} lower emissions weighted mean" class="legend-line" style=" font-size: 1.1rem; margin: 0 0 0 .3rem;">${round(chart_data['rcp45_mean'][month_idx], precision)}</div>
          </div>
